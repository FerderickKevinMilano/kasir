...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Mar 2024 pada 02.23
...
(6, 'Crot Pin-Pin', 'Jl Dr Sutomo', '08235235'),
(8, 'Ezy ', 'Jl Umi zubaidah No. 4', '08756732234'),
(9, 'Vincet Alfredo Butar Butar ', 'Sumatera Utara', '08235235');
...
(2, '2024-02-28', 3000, 9),
(15, '2024-02-14', 2000, 8),
(25, '2024-03-04', 3000, 9);
...
INSERT INTO `petugas` (`petugas`, `password`) VALUES
('Bunya', '1234567'),
('Kevin', '12345'),
('Riko ', '12345');
...
INSERT INTO `produk` (`ProdukID`, `NamaProduk`, `Harga`, `Stok`, `Keterangan`) VALUES
(6, 'Biji Kopi ', 20000.00, 30, 'Buah'),
(7, 'Chocolatos ', 2000.00, 20, 'kotak');
