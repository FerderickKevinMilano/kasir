...
.fa-caret-down {
  ...
  <body>
        ...
        <a href="dashboard.php"><i class="		fa fa-navicon"></i> Dashboard</a>
            <a href="#home"><i class="	fa fa-users"></i> Pelanggan</a>
        ...
        <table id="myTable">
          <thead>  
              <th colspan="4">TABEL DATA PELANGGAN</th> 
               <button type="text"><a href="inputpelanggan.html"><b>Tambah</b></a></button>
              <tr>
  <th class="abu">NAMA PELANGGAN</th>
  <th class="abu">ALAMAT</th>
  <th class="abu">NOMOR PELANGGAN</th>
  ...
  <tr>           
    ...
    <td><button type="text" class="edit"><a href="editpelanggan.php?id=<?php echo $tampil['PelangganID'];?>"><i class="		fa fa-pencil-square-o"></i></a></button></td> 
    <td><button type="text" class="hapus"><a href="hapuspelanggan.php?id=<?php echo $tampil['PelangganID'];?>"><i class="		fa fa-trash"></i></a></button></td>    
</tr>
