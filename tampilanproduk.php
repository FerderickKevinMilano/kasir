...
.dropdown-container {
  ...
  <body>
        ...
        <a href="dashboard.php"><i class="		fa fa-navicon"></i> Dashboard</a>
            ...
            <a href="#clients"><i class="	fa fa-inbox"></i> Stock Barang</a>
        ...
        <table id="myTable">
          <thead>
              ...
              <th colspan="4">TABEL DATA PRODUK</th>
               <button type="text"><a href="inputbarang.html"><b>Tambah</b></a></button>
              <tr>
  <th class="abu">NAMA PRODUK</th>
  <th class="abu">HARGA</th>
  <th class="abu">STOK</th>
  ...
  <td><?php echo $tampil['Stok'];?><?php echo $tampil['Keterangan'];?></td>
 
  <td><button type="text"><a href="editproduk.php?id=<?php echo $tampil['ProdukID'];?>"><i class="fa fa-pencil-square-o"></i></a></button></td>
  <td><button type="text"><a href="hapusproduk.php?id=<?php echo $tampil['ProdukID'];?>"><i class="		fa fa-trash"></i></a></button></td>
  </tr>
  <?php 
  }
  ?>
